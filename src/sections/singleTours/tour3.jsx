...
export const Tour3 = () => {
    return (
        <Modal
            ...
            <p></p>
            <img class="img-fluid" src="img/tour-3-body-1.jpg"></img>
            <h2>Day 2</h2>
            <h3>Lhasa Sightseeing (3650m)</h3>
            ...
            <h2>Day 4</h2>
            <h3>Lhasa to Shigatse (3850m) 350 km approx 7 to 8 hrs</h3>
            ...
            <img class="img-fluid" src="img/tour-3-body-2.jpg"></img>
            <h2>Day 5</h2>
            <h3>Shegatse to EBC(5200m) 350 km, approximately 7 to 8 hours drive.</h3>

            <p>Today on the way you can see the beautiful landscape of Tibet, highest point will the Everest basecamp and Gyatso la pass, which has (5200m), there will be two place from where you can see the Mount Everest. Staying Over night at Monastery Guest house or Tent </p>

            <p></p>

            <h2>Day 6</h2>
            <h3>EBC to Shigatse (3850m) approximately 7 to 8 hours drive.</h3>

            <p>Today on the way back to shigatse, views are same as what you have see yesterday, once you reach Shigatse interesting place to visit is Tashi Lhunpo monastery, which is the 5th largest monastery of Gelukpa Sect of Tibetan buddhism build during the time of first Dalai Lama in 14th century. Staying over night at Geysar Hotel </p>

            <p></p>


            <h2>Day 7</h2>
            <h3>Shigats to Namtso lake (4600m) approxmately 7.5 hours drive.</h3>

            <p>Today on the way from Shigatse to Namtso lake, you will see different landscape with great views, once you reach Namtso Lake you can do a round of Tashi Do Peninsula, Namtso lake, over night at Guest house.</p>

            <p></p>

            <h2>Day 8</h2>
            <h3>Namtso to lhasa (3650m) 250km approximately 4hours drive.</h3>

            <p>Today on the way from Namtso lake to lhasa you will see the Nachen Tangla Range and many more intersting landscape. Over night at Hotel in lhasa.</p>

            <p></p>

            <h3>Departure from lhasa,</h3>
